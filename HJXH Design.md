...
| `product-hand-grabbed-pancake` | `皇家小虎主产品摄影图/手抓饼.png` | 手抓饼产品真实摄影参考 |
...
皇家小虎主产品包括披萨、烤肠、蛋挞、芝士焗、薯条和手抓饼。AI MUST 优先使用目录内真实产品图，不得凭空重绘或改变产品事实。
...
| 手抓饼 | `皇家小虎主产品摄影图/手抓饼.png` | 真实摄影参考，保持饼皮层次、馅料结构、色泽与份量真实性 |
...
product_assets:
  ...
  hand_grabbed_pancake: "皇家小虎主产品摄影图/手抓饼.png"
