...
当用户明确需要“数据PPT”“年中分析”“半年经营分析”“完整横屏版”或要求按销售、活动、物料、现场照片完整呈现时，使用：

```text
assets/templates/数据PPT模版.html
```

- 固定 `1600×900`、15 页、单文件 HTML，适用于横屏演示、大屏与静态 PDF 导出。
- 结构固定为：封面、经营总览、销售结构、活动费效、活动执行、客户活动、人员活动、活动地点、物料总览、物料明细、联动诊断、经营动作、活动现场、终端门店、结束页。
- 模板中的 `{{...}}` 均为待替换占位符。必须用当前任务的数据、名称、时间和照片填充；缺少数据时保留占位符或写明“待补充”，不得编造。
- 不得保留模板来源报告中的省区、客户、门店、人员、金额、销量、费效、日期或现场照片。
- 第 13 页上传活动现场全景；第 14 页上传终端门店全景，优先展示门店整体环境与皇家小虎冰柜、吊牌、地贴等完整物料落地。
